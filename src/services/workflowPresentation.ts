...
const EN: LocalePack = {
  ...
  flow: {
    ...
    deviceTtsLabel: 'Speak with device TTS', deviceTtsDetail: 'Listening stays open while phrases translate in the background. Tap a transcript line to hear it with an installed target-language voice.',
...
const KO: LocalePack = {
  ...
  flow: {
    ...
    deviceTtsLabel: '기기 TTS로 읽기', deviceTtsDetail: '듣는 동안에도 문장 단위로 백그라운드 번역이 이어집니다. 설치된 대상 언어 음성으로 들으려면 기록을 누르세요.',
