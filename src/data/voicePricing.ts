...
export const VOICE_ALTERNATIVES: readonly AlternativeProvider[] = [
  ...
  },
  {
    ...
    free: {
      ko: '현재 글먼저 모드의 우선 경로',
      en: 'The preferred path in the current Text First mode',
      ja: '現在の「テキスト優先」モードの優先経路',
      'zh-TW': '目前「文字優先」模式的首選路徑',
      zh: '当前“文字优先”模式的首选路径',
      es: 'La ruta preferida del modo Texto primero actual',
      fr: 'Le parcours privilégié du mode Texte d’abord actuel',
      de: 'Der bevorzugte Pfad im aktuellen Modus „Text zuerst“',
      vi: 'Lộ trình ưu tiên trong chế độ Văn bản trước hiện tại',
    },
    caveat: {
